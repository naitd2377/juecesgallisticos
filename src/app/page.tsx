    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="container mx-auto px-4 py-20 text-center flex-1 flex flex-col justify-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
          Servicios profesionales de juzgamiento para eventos gallísticos. Contamos con equipo de cómputo, bocina, pantallas, báscula digital y todo lo necesario para un evento exitoso.
        </p>
      ...
      <section className="bg-secondary/30 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">Contamos con tres jueces especializados para garantizar la transparencia y profesionalismo en cada evento</p>
          </div>
      ...
      <section id="servicios" className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">Ofrecemos todo el equipo y servicios necesarios para que tu evento gallístico sea un éxito total</p>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <Card className="bg-primary text-primary-foreground border-0">
          <CardContent className="p-12 text-center">
            ...
            <p className="mb-8 opacity-90 max-w-xl mx-auto">Contáctanos para información y presupuestos. Estamos disponibles para eventos en toda la región.</p>
            <div className="flex gap-4 justify-center flex-wrap">
